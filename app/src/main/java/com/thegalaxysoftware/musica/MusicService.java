...
import com.thegalaxysoftware.musica.Helpers.MediaButtonIntentReceiver;
import com.thegalaxysoftware.musica.Helpers.MusicPlaybackTrack;
import com.thegalaxysoftware.musica.LastFMApi.LastFmClient;
import com.thegalaxysoftware.musica.LastFMApi.Models.LastfmUserSession;
import com.thegalaxysoftware.musica.LastFMApi.Models.ScrobbleQuery;
import com.thegalaxysoftware.musica.Permissions.Nammu;
import com.thegalaxysoftware.musica.Providers.MusicPlaybackState;
import com.thegalaxysoftware.musica.Providers.RecentStore;
import com.thegalaxysoftware.musica.Providers.SongPlayCount;
...
import com.thegalaxysoftware.musica.Utils.MusicaUtils.IdType;
...
public class MusicService extends Service {
    ...
    public static final String PLAYSTATE_CHANGED = "com.thegalaxysoftware.musica.playstatechanged";
    public static final String POSITION_CHANGED = "com.thegalaxysoftware.musica.positionchanged";
    public static final String META_CHANGED = "com.thegalaxysoftware.musica.metachanged";
    public static final String QUEUE_CHANGED = "com.thegalaxysoftware.musica.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.thegalaxysoftware.musica.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.thegalaxysoftware.musica.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.thegalaxysoftware.musica.shufflemodechanged";
    public static final String TRACK_ERROR = "com.thegalaxysoftware.musica.trackerror";
    public static final String TIMBER_PACKAGE_NAME = "com.thegalaxysoftware.musica.timber";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.thegalaxysoftware.musica.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.thegalaxysoftware.musica.togglepause";
    public static final String PAUSE_ACTION = "com.thegalaxysoftware.musica.pause";
    public static final String STOP_ACTION = "com.thegalaxysoftware.musica.stop";
    public static final String PREVIOUS_ACTION = "com.thegalaxysoftware.musica.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.thegalaxysoftware.musica.previous.force";
    public static final String NEXT_ACTION = "com.thegalaxysoftware.musica.next";
    public static final String REPEAT_ACTION = "com.thegalaxysoftware.musica.repeat";
    public static final String SHUFFLE_ACTION = "com.thegalaxysoftware.musica.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.thegalaxysoftware.musica.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.thegalaxysoftware.musica.updatelockscreen";
    ...
    private static final String SHUTDOWN = "com.thegalaxysoftware.musica.shutdown";
    ...
    public void onCreate() {
        ...
        PreferencesUtility pref = PreferencesUtility.getsInstance(this);
    ...
    {
        mSession = new MediaSessionCompat(this, "Musica");
    ...
    private void handleCommandIntent(Intent intent)
    {
        ...
        if (CMDNEXT.equals(command) || NEXT_ACTION.equals(action)) {
            ...
            if (PreferencesUtility.getsInstance(getApplicationContext()).pauseEnabledOnDetach()) {
                pause();
            }
        }
    }
    ...
    private void addToPlayList(final long[] list, int position, long sourceId, MusicaUtils.IdType sourceType) {
    ...
    private void doAutoShuffleUpdate() {
        ...
        for (int i = 0; i < toAdd; i++) {
            ...
            mPlaylist.add(new MusicPlaybackTrack(mAutoShuffleList[idx], -1, MusicaUtils.IdType.NA, -1));
            notify = true;
        }
        if (notify) {
            notifyChange(QUEUE_CHANGED);
        ...
        if (mRemoteControlClient != null) {
            ...
            if (what.equals(META_CHANGED) || what.equals(QUEUE_CHANGED)) {
                ...
                if (mShowAlbumArtOnLockscreen) {
                    albumArt = ImageLoader.getInstance().loadImageSync(MusicaUtils.getAlbumArtUri(getAlbumId()).toString());
                    if (albumArt != null) {
    ...
    private Notification buildNotification()
    {
        ...
        int playButtonResId = isPlaying
                ? R.drawable.ic_pause_white_24 : R.drawable.ic_play_white_24;

        Intent nowPlayingIntent = NavigationUtils.getNowPlayingIntent(this);
        PendingIntent clickIntent = PendingIntent.getActivity(this, 0, nowPlayingIntent, PendingIntent.FLAG_UPDATE_CURRENT);
        Bitmap artwork;
        artwork = ImageLoader.getInstance().loadImageSync(MusicaUtils.getAlbumArtUri(getAlbumId()).toString());

        if (artwork == null) {
            artwork = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.defaultmusic);
        }
        ...
        if (artwork != null && MusicaUtils.isLollipop()) {
            ...
            if (c != null && c.getCount() != 0) {
                ...
                do {
                    TrackItem t = new TrackItem()
                            .setArt(MusicaUtils.getAlbumArtUri(c.getLong(c.getColumnIndexOrThrow(MediaStore.Audio.AudioColumns.ALBUM_ID))))
                            ...
                            .setDuration(MusicaUtils.makeShortTimeString(this, c.getInt(c.getColumnIndexOrThrow(MediaStore.Audio.AudioColumns.DURATION)) / 1000));
                    list.add(t.get());
                } while (c.moveToNext());
                try {
                ...
                try {
                    if (mCursor != null && shouldAddToPlaylist) {
                        ...
                        mPlaylist.add(new MusicPlaybackTrack(
                                mCursor.getLong(IDCOLIDX), -1, MusicaUtils.IdType.NA, -1));
                        notifyChange(QUEUE_CHANGED);
                        mPlayPos = 0;
                        mHistory.clear();
                    }
    ...
    public void open(final long[] list, final int position, long sourceId, MusicaUtils.IdType sourceType) {
        synchronized (this) {
            if (mShuffleMode == SHUFFLE_AUTO) {
...
//            }
    ...
    private static final class ServiceStub extends IMusicaService.Stub
    {
        private final WeakReference<MusicService> mService;
