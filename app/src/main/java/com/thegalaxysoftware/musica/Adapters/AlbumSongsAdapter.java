...
public class AlbumSongsAdapter extends BaseSongAdapter<AlbumSongsAdapter.ItemHolder> {
    ...
    public void onBindViewHolder(@NonNull ItemHolder itemHolder, int i) {
        ...
        itemHolder.duration.setText(MusicaUtils.makeShortTimeString(mContext, (localItem.duration) / 1000));
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        switch (item.getItemId())
                        {
                            ...
                            case R.id.popup_song_delete:
                                ...
                                MusicaUtils.showDeleteDialog(mContext, arraylist.get(position).title, deleteIds, AlbumSongsAdapter.this, position);
                                break;
                        }
                        return false;
                    }
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    playAll(mContext, songIDs, getAdapterPosition(), albumID,
                            MusicaUtils.IdType.Album, false,
