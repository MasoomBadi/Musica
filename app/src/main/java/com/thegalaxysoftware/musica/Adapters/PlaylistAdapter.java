...
public class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.ItemHolder> {
    ...
    public PlaylistAdapter(Activity context, List<Playlist> arraylist) {
        ...
        this.isGrid = PreferencesUtility.getsInstance(mContext).getPlaylistView() == Constants.PLAYLIST_VIEW_GRID;
        this.showAuto = PreferencesUtility.getsInstance(mContext).showAutoPlaylist();
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int position) {
        ...
        String s = getAlbumArtUri(position, localItem.id);
                            ...
                            new Palette.Builder(loadedImage).generate(new Palette.PaletteAsyncListener() {
                                ...
                                public void onGenerated(Palette palette) {
                                    ...
                                    if (swatch != null) {
                                        ...
                                        int textColor = MusicaUtils.getBlackWhiteColor(swatch.getTitleTextColor());
                                        ...
                                        if (mutedSwatch != null) {
                                            ...
                                            itemHolder.footer.setBackgroundColor(color);
                                            int textColor = MusicaUtils.getBlackWhiteColor(mutedSwatch.getTitleTextColor());
                                            itemHolder.title.setTextColor(textColor);
                                            itemHolder.artist.setTextColor(textColor);
                                        }
                                    }
        ...
        itemHolder.artist.setText(" " + String.valueOf(songCountInt) + " " + mContext.getString(R.string.songs) + " - " + MusicaUtils.makeShortTimeString(mContext, totalRuntime));
                ...
                switch (position) {
                    case 0:
                        ...
                        if (songCountInt != 0) {
                            ...
                            return MusicaUtils.getAlbumArtUri(firstAlbumID).toString();
                        } else return "nosongs";
