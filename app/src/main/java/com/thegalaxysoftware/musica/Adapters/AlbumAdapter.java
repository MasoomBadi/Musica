...
public class AlbumAdapter extends RecyclerView.Adapter<AlbumAdapter.ItemHolder> {
    ...
    public AlbumAdapter(Activity context, List<Album> arraylist) {
        ...
        this.isGrid = PreferencesUtility.getsInstance(mContext).isAlbumsInGrid();
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int position) {
        ...
        ImageLoader.getInstance().displayImage(MusicaUtils.getAlbumArtUri(localItem.id).toString(), itemHolder.albumArt,
