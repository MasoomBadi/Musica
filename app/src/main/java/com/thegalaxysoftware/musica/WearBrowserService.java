...
public class WearBrowserService extends MediaBrowserService {
    ...
    private final class MediaSessionCallback extends MediaSession.Callback {
        ...
        public void onPlayFromMediaId(String mediaId, Bundle extras) {
            ...
            setSessionActive();
            MusicPlayer.playAll(mContext, new long[]{songId}, 0, -1, MusicaUtils.IdType.NA, false);
    ...
    private void addMediaRoots(List<MediaBrowser.MediaItem> mMediaRoot) {
        mMediaRoot.add(new MediaBrowser.MediaItem(
                new MediaDescription.Builder()
                        ...
                        .setIconUri(Uri.parse("android.resource://" + "thegalaxysoftware.musica/drawable/defaultmusic"))
                ...
                else
                {
                    switch (Integer.parseInt(Character.toString(parentId.charAt(0))))
                    {
                        case TYPE_ARTIST:
                            ...
                            {
                                String albumNumber = MusicaUtils.makeLabel(mContext, R.plurals.Nalbums, artist.albumCount);
                                ...
                                "thegalaxysoftware.musica/drawable/defaultmusic"), MusicaUtils.makeCombinedString(mContext, albumNumber, songCount), MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        ...
                        case TYPE_ALBUM:
                            ...
                            for (Album album : albumList) {
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ALBUM_SONGS) + Long.toString(album.id), album.title, MusicaUtils.getAlbumArtUri(album.id), album.artistName, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
                        ...
                        case TYPE_SONG:
                            ...
                            for (Song song : songList) {
                                fillMediaItems(mediaItems, String.valueOf(song.id), song.title, MusicaUtils.getAlbumArtUri(song.albumId), song.artistName, MediaBrowser.MediaItem.FLAG_PLAYABLE);
                            }
                            break;
                        ...
                        case TYPE_ARTIST_SONG_ALBUMS:
                            ...
                            "thegalaxysoftware.musica/drawable/defaultmusic"), "All songs by artist", MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            List<Album> artistAlbums = ArtistAlbumLoader.getAlbumsForArtist(mContext, Long.parseLong(parentId.substring(1)));
                            for (Album album : artistAlbums) {
                                String songCount = MusicaUtils.makeLabel(mContext, R.plurals.Nsongs, album.songCount);
                                fillMediaItems(mediaItems, Integer.toString(TYPE_ALBUM_SONGS) + Long.toString(album.id), album.title, MusicaUtils.getAlbumArtUri(album.id), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                        ...
                        case TYPE_ARTIST_ALL_SONGS:
                            ...
                            for (Song song : artistSongs) {
                                fillMediaItems(mediaItems, String.valueOf(song.id), song.title, MusicaUtils.getAlbumArtUri(song.albumId), song.albumName, MediaBrowser.MediaItem.FLAG_PLAYABLE);
                            }
                            break;
                        ...
                        case TYPE_PLAYLIST:
                            ...
                            {
                                String songCount = MusicaUtils.makeLabel(mContext, R.plurals.Nsongs, playlist.songCount);
                                fillMediaItems(mediaItems, Integer.toString(TYPE_PLAYLIST_ALL_SONGS) + Long.toString(playlist.id), playlist.name,
                                        Uri.parse("android.resource://" +
                                        "thegalaxysoftware.musica/drawable/defaultmusic"), songCount, MediaBrowser.MediaItem.FLAG_BROWSABLE);
                            }
                            break;
