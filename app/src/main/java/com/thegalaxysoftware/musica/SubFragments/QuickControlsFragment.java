...
public class QuickControlsFragment extends Fragment implements MusicStateListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (PreferencesUtility.getsInstance(getActivity()).isGesturesEnabled()) {
    ...
    public void updateNowplayingCard() {
        ...
        if (!duetoplaypause) {
            ImageLoader.getInstance().displayImage(MusicaUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), mAlbumArt,
