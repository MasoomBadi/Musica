...
public class MusicPlaybackTrack implements Parcelable {
    ...
    public MusicaUtils.IdType mSourceType;
    public int mSourcePosition;

    public MusicPlaybackTrack(long id, long sourceId, MusicaUtils.IdType type, int sourcePosition) {
        mId = id;
        mSourceId = sourceId;
        mSourceType = type;
    ...
    public MusicPlaybackTrack(Parcel in) {
        ...
        mSourceType = MusicaUtils.IdType.getTypeById(in.readInt());
