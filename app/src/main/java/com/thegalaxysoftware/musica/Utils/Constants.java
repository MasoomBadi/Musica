...
public class Constants {
    ...
    public static final String MUSICA1 = "musica1";
    public static final String MUSICA2 = "musica2";
    public static final String MUSICA3 = "musica3";
    public static final String MUSICA4 = "musica4";
    public static final String MUSICA5 = "musica5";
    public static final String MUSICA6 = "musica6";
