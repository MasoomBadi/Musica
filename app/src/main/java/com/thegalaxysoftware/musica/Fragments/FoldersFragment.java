...
import com.thegalaxysoftware.musica.Adapters.FolderAdapter;
import com.thegalaxysoftware.musica.Dialogs.StorageSelectDialog;
...
public class FoldersFragment extends Fragment implements StorageSelectDialog.OnDirSelectListener {
    ...
    private class loadFolders extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            if (activity != null) {
                mAdapter = new FolderAdapter(activity, new File(PreferencesUtility.getsInstance(activity).getLastFolder()));
                updateTheme();
            }
            return "Executed";
        }
