...
import com.thegalaxysoftware.musica.Adapters.PlaylistAdapter;
import com.thegalaxysoftware.musica.BeanClass.Playlist;
import com.thegalaxysoftware.musica.Dialogs.CreatePlaylistDialog;
import com.thegalaxysoftware.musica.Dataloaders.PlaylistLoader;
import com.thegalaxysoftware.musica.R;
import com.thegalaxysoftware.musica.SubFragments.PlaylistPagerFragment;
...
public class PlaylistFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fabcreatePlaylist = (FloatingActionButton)rootView.findViewById(R.id.fab_createnewplaylist);
        ...
        ATEUtils.setFabBackgroundTint(fabcreatePlaylist, Config.accentColor(context, Helpers.getATEKey(context)));
        fabcreatePlaylist.setImageDrawable(builder.build());
