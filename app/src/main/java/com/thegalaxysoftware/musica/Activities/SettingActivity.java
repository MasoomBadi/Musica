...
import com.thegalaxysoftware.musica.SubFragments.StyleSelectorFragment;
import com.thegalaxysoftware.musica.Utils.Constants;
import com.thegalaxysoftware.musica.Utils.PreferencesUtility;

public class SettingActivity extends BaseThemedActivity implements ColorChooserDialog.ColorCallback, ATEActivityThemeCustomizer {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (PreferencesUtility.getsInstance(this).getTheme().equals("dark"))
            setTheme(R.style.AppThemeNormalDark);
        else if (PreferencesUtility.getsInstance(this).getTheme().equals("black"))
