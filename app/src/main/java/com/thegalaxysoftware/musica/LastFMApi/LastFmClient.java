...
import com.thegalaxysoftware.musica.LastFMApi.Models.ScrobbleInfo;
import com.thegalaxysoftware.musica.LastFMApi.Models.ScrobbleQuery;
import com.thegalaxysoftware.musica.LastFMApi.Models.UserLoginInfo;
...
public class LastFmClient {
    ...
    public static final String API_KEY = "2bdcbe359b44119baba1012e53231e97";
    public static final String API_SECRET = "eb2ec2ba52c6ca60e7672eddb518fec7";
    ...
    public void getUserLoginInfo(UserLoginQuery userLoginQuery, final UserListener listener) {
        mUserRestService.getUserLoginInfo(UserLoginQuery.Method, JSON, API_KEY, generateMD5(userLoginQuery.getSignature()), userLoginQuery.mUsername, userLoginQuery.mPassword, new Callback<UserLoginInfo>() {
            ...
            public void success(UserLoginInfo userLoginInfo, Response response) {
                ...
                PreferencesUtility.getsInstance(context).updateService(extras);
